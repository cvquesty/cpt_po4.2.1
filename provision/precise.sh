...
/usr/bin/wget https://apt.puppetlabs.com/puppetlabs-release-pc1-precise.deb /tmp/puppetlabs-release-pc1-precise.deb
/usr/bin/dpkg -i puppetlabs-release-pc1-precise.deb
